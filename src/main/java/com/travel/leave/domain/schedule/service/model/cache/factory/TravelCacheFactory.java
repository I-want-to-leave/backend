package com.travel.leave.domain.schedule.service.model.cache.factory;
...
import com.travel.leave.domain.schedule.controller.socket.messageFormat.preparation.PreparationMessage;
import com.travel.leave.domain.schedule.controller.socket.messageFormat.preparation.UpdateTravelPreparationMessage;
import com.travel.leave.domain.schedule.controller.socket.messageFormat.timeline.ScheduleMessage;
import com.travel.leave.domain.schedule.controller.socket.messageFormat.timeline.TimeLineMessage;
...
public class TravelCacheFactory {
    ...
    public TravelCache createTravelCache(Travel travel,
        ...
        return TravelCache.of(
                ...
                travel.getName(),
                travel.getContent(),
                travel.getStartDate().toLocalDate(),
                travel.getEndDate().toLocalDate(),
                travel.getCreatedAt(),
                travel.getDeletedAt(),

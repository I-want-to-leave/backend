package com.travel.leave.domain.schedule.controller.socket;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.travel.leave.domain.schedule.controller.socket.messageFormat.MessageFormatMapper;
import com.travel.leave.domain.schedule.service.ScheduleService;
...
public class SocketMessageHandler {
    ...
    public void init() {
        serviceHandlers.put(
                ServiceType.UPDATE_TRAVEL_LOCATION.getMethodName(), this::updateTravelLocation);
        serviceHandlers.put(
                ServiceType.UPDATE_TRAVEL_CONTENT.getMethodName(), this::updateTravelContent);
        serviceHandlers.put(
                ServiceType.UPDATE_TRAVEL_PREPARATION.getMethodName(), this::updateTravelPreparation);
        serviceHandlers.put(
                ServiceType.UPDATE_TRAVEL_NAME.getMethodName(), this::updateTravelName);
        serviceHandlers.put(
                ServiceType.UPDATE_TRAVEL_LOCATION_GEOGRAPHIC.getMethodName(), this::updateTravelLocationGeographic);
    }
    ...
    private String updateTravelContent(String message) { //소켓 메시지로 Travel 정보 업데이트
    ...
    private String updateTravelLocationGeographic(String message) {
        travelCacheHandler.updateTravelLocationGeographic(messageFormatMapper.mapToUpdateTravelLocationGeographic(message));
        return message;
    }
}

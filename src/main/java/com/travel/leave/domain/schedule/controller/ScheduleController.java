package com.travel.leave.domain.schedule.controller;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.travel.leave.domain.schedule.controller.socket.SocketMessageHandler;
...
public class ScheduleController {
    ...
    public ResponseEntity<?> initializeSchedule(@AuthenticationPrincipal Long userCode,
        ...
        log.info("{}worldly", travelRequestDTO.image().get(0));
